<?php /* Smarty version 2.6.31, created on 2018-10-03 17:45:58
...
<div class="col-xs-12 col-sm-4 label" data-label="LBL_PAT_PATIENTS_ACCOUNTS_FROM_PAT_PATIENTS_TITLE">

<?php $this->_tag_stack[] = array('minify', array()); $_block_repeat=true;smarty_block_minify($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PAT_PATIENTS_ACCOUNTS_FROM_PAT_PATIENTS_TITLE','module' => 'Accounts'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
...
<div class="col-xs-12 col-sm-8 edit-view-field " type="relate" field="pat_patients_accounts_name"  >
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>


<input type="text" name="<?php echo $this->_tpl_vars['fields']['pat_patients_accounts_name']['name']; ?>
" class="sqsEnabled" tabindex="0" id="<?php echo $this->_tpl_vars['fields']['pat_patients_accounts_name']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['pat_patients_accounts_name']['value']; ?>
" title='' autocomplete="off"  	 >
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['pat_patients_accounts_name']['id_name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['pat_patients_accounts_name']['id_name']; ?>
" 
value="<?php echo $this->_tpl_vars['fields']['pat_patients_accountspat_patients_ida']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['pat_patients_accounts_name']['name']; ?>
" id="btn_<?php echo $this->_tpl_vars['fields']['pat_patients_accounts_name']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SELECT_BUTTON_TITLE'), $this);?>
" class="button firstChild" value="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SELECT_BUTTON_LABEL'), $this);?>
"
onclick='open_popup(
"<?php echo $this->_tpl_vars['fields']['pat_patients_accounts_name']['module']; ?>
", 
600, 
400, 
"", 
true, 
false, 
<?php echo '{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"pat_patients_accountspat_patients_ida","name":"pat_patients_accounts_name"}}'; ?>
, 
"single", 
true
);' ><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['pat_patients_accounts_name']['name']; ?>
" id="btn_clr_<?php echo $this->_tpl_vars['fields']['pat_patients_accounts_name']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_CLEAR_RELATE_TITLE'), $this);?>
"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['pat_patients_accounts_name']['name']; ?>
', '<?php echo $this->_tpl_vars['fields']['pat_patients_accounts_name']['id_name']; ?>
...
_<?php echo $this->_tpl_vars['fields']['pat_patients_accounts_name']['name']; ?>
']) != 'undefined'",
		enableQS
);
</script>
...
addToValidateBinaryDependency(\'EditView\', \'pat_patients_accounts_name\', \'alpha\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'Accounts','for_js' => true), $this);?>
<?php echo ': '; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_PAT_PATIENTS_ACCOUNTS_FROM_PAT_PATIENTS_TITLE','module' => 'Accounts','for_js' => true), $this);?>
<?php echo '\', \'pat_patients_accountspat_patients_ida\' );
</script><script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'EditView_pat_patients_accounts_name\']={"form":"EditView","method":"query","modules":["pat_Patients"],"group":"or","field_list":["name","id"],"populate_list":["pat_patients_accounts_name","pat_patients_accountspat_patients_ida"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};</script>'; ?>
