...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_PAT_PATIENTS_ACCOUNTS_FROM_PAT_PATIENTS_TITLE' module='Accounts'}{/capture}
{$label|strip_semicolon}:
...
<input type="text" name="{$fields.pat_patients_accounts_name.name}" class="sqsEnabled" tabindex="0" id="{$fields.pat_patients_accounts_name.name}" size="" value="{$fields.pat_patients_accounts_name.value}" title='' autocomplete="off"  	 >
...
<button type="button" name="btn_{$fields.pat_patients_accounts_name.name}" id="btn_{$fields.pat_patients_accounts_name.name}" tabindex="0" title="{sugar_translate label="LBL_SELECT_BUTTON_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_SELECT_BUTTON_LABEL"}"
onclick='open_popup(
...
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"pat_patients_accountspat_patients_ida","name":"pat_patients_accounts_name"}}{/literal}, 
"single", 
true
);' ><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_{$fields.pat_patients_accounts_name.name}" id="btn_clr_{$fields.pat_patients_accounts_name.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_TITLE"}"  class="button lastChild"
...
addToValidateBinaryDependency('EditView', 'pat_patients_accounts_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Accounts' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_PAT_PATIENTS_ACCOUNTS_FROM_PAT_PATIENTS_TITLE' module='Accounts' for_js=true}{literal}', 'pat_patients_accountspat_patients_ida' );
</script><script language="javascript">if(typeof sqs_objects == 'undefined'){var sqs_objects = new Array;}sqs_objects['EditView_pat_patients_accounts_name']={"form":"EditView","method":"query","modules":["pat_Patients"],"group":"or","field_list":["name","id"],"populate_list":["pat_patients_accounts_name","pat_patients_accountspat_patients_ida"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};</script>{/literal}
