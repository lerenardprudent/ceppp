...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_EXPERIENCE_MALADIE' module='Accounts'}{/capture}
{$label|strip_semicolon}:
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_DOMAINE_SOIN' module='Accounts'}{/capture}
{$label|strip_semicolon}:
...
{if strlen($fields.domaine_soin_c.value) <= 0}
{assign var="value" value=$fields.domaine_soin_c.default_value }
{else}
{assign var="value" value=$fields.domaine_soin_c.value }
{/if}  
<input type='text' name='{$fields.domaine_soin_c.name}' 
id='{$fields.domaine_soin_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_DOMAINE_SOIN_2' module='Accounts'}{/capture}
{$label|strip_semicolon}:
...
{if strlen($fields.domaine_soin_2_c.value) <= 0}
{assign var="value" value=$fields.domaine_soin_2_c.default_value }
{else}
{assign var="value" value=$fields.domaine_soin_2_c.value }
{/if}  
<input type='text' name='{$fields.domaine_soin_2_c.name}' 
id='{$fields.domaine_soin_2_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_DOMAINE_SOIN_3' module='Accounts'}{/capture}
{$label|strip_semicolon}:
...
{if strlen($fields.domaine_soin_3_c.value) <= 0}
{assign var="value" value=$fields.domaine_soin_3_c.default_value }
{else}
{assign var="value" value=$fields.domaine_soin_3_c.value }
{/if}  
<input type='text' name='{$fields.domaine_soin_3_c.name}' 
id='{$fields.domaine_soin_3_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_MED_1' module='Accounts'}{/capture}
{$label|strip_semicolon}:
...
<select name="{$fields.med_1_c.name}" 
id="{$fields.med_1_c.name}" 
title=''       
>
{if isset($fields.med_1_c.value) && $fields.med_1_c.value != ''}
{html_options options=$fields.med_1_c.options selected=$fields.med_1_c.value}
{else}
{html_options options=$fields.med_1_c.options selected=$fields.med_1_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.med_1_c.options }
{capture name="field_val"}{$fields.med_1_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.med_1_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.med_1_c.name}" 
id="{$fields.med_1_c.name}" 
title=''          
>
{if isset($fields.med_1_c.value) && $fields.med_1_c.value != ''}
...
<input
id="{$fields.med_1_c.name}-input"
name="{$fields.med_1_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.med_1_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.med_1_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.med_1_c.name}-input', '{$fields.med_1_c.name}');sync_{$fields.med_1_c.name}()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
{literal}
<script>
	...
	{/literal}
			...
			{literal}
		(function (){
			var selectElem = document.getElementById("{/literal}{$fields.med_1_c.name}{literal}");
	...
	SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.med_1_c.name}-input');
	SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.med_1_c.name}-image');
	SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.med_1_c.name}');
			...
			//global variable 
			sync_{/literal}{$fields.med_1_c.name}{literal} = function(){
				SyncToHidden();
			}
			function syncFromHiddenToWidget(){
				...
				for (i=0;i<selectElem.options.length;i++){
					...
					if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.med_1_c.name}-input{literal}'))
						SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
				}
			}

            YAHOO.util.Event.onAvailable("{/literal}{$fields.med_1_c.name}{literal}", syncFromHiddenToWidget);
		{/literal}
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_MED_2' module='Accounts'}{/capture}
{$label|strip_semicolon}:
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.med_2_c.name}" 
id="{$fields.med_2_c.name}" 
title=''       
>
{if isset($fields.med_2_c.value) && $fields.med_2_c.value != ''}
{html_options options=$fields.med_2_c.options selected=$fields.med_2_c.value}
{else}
{html_options options=$fields.med_2_c.options selected=$fields.med_2_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.med_2_c.options }
{capture name="field_val"}{$fields.med_2_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.med_2_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.med_2_c.name}" 
id="{$fields.med_2_c.name}" 
title=''          
>
{if isset($fields.med_2_c.value) && $fields.med_2_c.value != ''}
...
<input
id="{$fields.med_2_c.name}-input"
name="{$fields.med_2_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.med_2_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.med_2_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.med_2_c.name}-input', '{$fields.med_2_c.name}');sync_{$fields.med_2_c.name}()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
{literal}
<script>
	SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
	{/literal}
			...
			{literal}
		(function (){
			var selectElem = document.getElementById("{/literal}{$fields.med_2_c.name}{literal}");
	...
	SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.med_2_c.name}-input');
	SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.med_2_c.name}-image');
	SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.med_2_c.name}');
			...
			//global variable 
			sync_{/literal}{$fields.med_2_c.name}{literal} = function(){
				SyncToHidden();
			}
			function syncFromHiddenToWidget(){
				...
				for (i=0;i<selectElem.options.length;i++){
					...
					if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.med_2_c.name}-input{literal}'))
						SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
				}
			}

            YAHOO.util.Event.onAvailable("{/literal}{$fields.med_2_c.name}{literal}", syncFromHiddenToWidget);
		{/literal}
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_MED_3' module='Accounts'}{/capture}
{$label|strip_semicolon}:
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.med_3_c.name}" 
id="{$fields.med_3_c.name}" 
title=''       
>
{if isset($fields.med_3_c.value) && $fields.med_3_c.value != ''}
{html_options options=$fields.med_3_c.options selected=$fields.med_3_c.value}
{else}
{html_options options=$fields.med_3_c.options selected=$fields.med_3_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.med_3_c.options }
{capture name="field_val"}{$fields.med_3_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.med_3_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.med_3_c.name}" 
id="{$fields.med_3_c.name}" 
title=''          
>
{if isset($fields.med_3_c.value) && $fields.med_3_c.value != ''}
...
<input
id="{$fields.med_3_c.name}-input"
name="{$fields.med_3_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.med_3_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.med_3_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.med_3_c.name}-input', '{$fields.med_3_c.name}');sync_{$fields.med_3_c.name}()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
{literal}
<script>
	SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
	{/literal}
			...
			{literal}
		(function (){
			var selectElem = document.getElementById("{/literal}{$fields.med_3_c.name}{literal}");
	...
	SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.med_3_c.name}-input');
	SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.med_3_c.name}-image');
	SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.med_3_c.name}');
			...
			//global variable 
			sync_{/literal}{$fields.med_3_c.name}{literal} = function(){
				SyncToHidden();
			}
			function syncFromHiddenToWidget(){
				...
				for (i=0;i<selectElem.options.length;i++){
					...
					if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.med_3_c.name}-input{literal}'))
						SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
				}
			}

            YAHOO.util.Event.onAvailable("{/literal}{$fields.med_3_c.name}{literal}", syncFromHiddenToWidget);
		{/literal}
...
addToValidate('EditView', 'accounts_am_projecttemplates_1_name', 'relate', false,'{/literal}{sugar_translate label='LBL_ACCOUNTS_AM_PROJECTTEMPLATES_1_FROM_AM_PROJECTTEMPLATES_TITLE' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'pat_patients_accounts_name', 'relate', false,'{/literal}{sugar_translate label='LBL_PAT_PATIENTS_ACCOUNTS_FROM_PAT_PATIENTS_TITLE' module='Accounts' for_js=true}{literal}' );
...
addToValidate('EditView', 'med_1_c', 'enum', false,'{/literal}{sugar_translate label='LBL_MED_1' module='Accounts' for_js=true}{literal}' );
