...
{if !$fields.pat_patients_accounts_name.hidden}
{counter name="panelFieldCount" print=false}

{if !empty($fields.pat_patients_accountspat_patients_ida.value)}
{capture assign="detail_url"}index.php?module=pat_Patients&action=DetailView&record={$fields.pat_patients_accountspat_patients_ida.value}{/capture}
<a href="{sugar_ajax_url url=$detail_url}">{/if}
<span id="pat_patients_accountspat_patients_ida" class="sugar_field" data-id-value="{$fields.pat_patients_accountspat_patients_ida.value}">{$fields.pat_patients_accounts_name.value}</span>
{if !empty($fields.pat_patients_accountspat_patients_ida.value)}</a>{/if}
{/if}
