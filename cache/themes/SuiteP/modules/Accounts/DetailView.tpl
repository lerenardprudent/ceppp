...
{if !$fields.experience_maladie_c.hidden}
{counter name="panelFieldCount" print=false}

<span class="sugar_field" id="{$fields.experience_maladie_c.name|escape:'html'|url2html|nl2br}">{$fields.experience_maladie_c.value|escape:'html'|escape:'html_entity_decode'|url2html|nl2br}</span>
{/if}
...
{if !$fields.domaine_soin_c.hidden}
{counter name="panelFieldCount" print=false}
...
{/if} 
<span class="sugar_field" id="{$fields.domaine_soin_c.name}">{$fields.domaine_soin_c.value}</span>
{/if}
...
{if !$fields.domaine_soin_2_c.hidden}
{counter name="panelFieldCount" print=false}
...
{/if} 
<span class="sugar_field" id="{$fields.domaine_soin_2_c.name}">{$fields.domaine_soin_2_c.value}</span>
{/if}
...
{if !$fields.domaine_soin_3_c.hidden}
{counter name="panelFieldCount" print=false}
...
{/if} 
<span class="sugar_field" id="{$fields.domaine_soin_3_c.name}">{$fields.domaine_soin_3_c.value}</span>
{/if}
...
{if !$fields.med_1_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.med_1_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.med_1_c.name}" value="{ $fields.med_1_c.options }">
{ $fields.med_1_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.med_1_c.name}" value="{ $fields.med_1_c.value }">
{ $fields.med_1_c.options[$fields.med_1_c.value]}
{/if}
{/if}
...
{if !$fields.med_2_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.med_2_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.med_2_c.name}" value="{ $fields.med_2_c.options }">
{ $fields.med_2_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.med_2_c.name}" value="{ $fields.med_2_c.value }">
{ $fields.med_2_c.options[$fields.med_2_c.value]}
{/if}
{/if}
...
{if !$fields.med_3_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.med_3_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.med_3_c.name}" value="{ $fields.med_3_c.options }">
{ $fields.med_3_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.med_3_c.name}" value="{ $fields.med_3_c.value }">
{ $fields.med_3_c.options[$fields.med_3_c.value]}
{/if}
{/if}
...
{if !$fields.doul_chron_c.hidden}
{counter name="panelFieldCount" print=false}

<span class="sugar_field" id="{$fields.doul_chron_c.name}">
{ $fields.doul_chron_c.options[$fields.doul_chron_c.value]}
</span>
{/if}
